...
//Update Title at Gallery Database 
        $UpdateImgTitle = "UPDATE gallery SET title = '".$_POST['update_title']."' WHERE adID = '".$_SESSION['edit_add_id']."'";
...
//Add Images        
        ...
        header('Location: o_advertisement_gallery.php');
